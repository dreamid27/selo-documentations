...
Next.js gagal membangun produksi Anda (`next build`) ketika kesalahan TypeScript hadir dalam proyek Anda.

Jika Anda ingin Next.js memproduksi kode produksi dengan bahaya bahkan ketika aplikasi Anda memiliki kesalahan, Anda dapat menonaktifkan langkah pemeriksaan tipe bawaan.
...
module.exports = {
  typescript: {
    // !! PERINGATAN !!
    // Dengan berbahaya memungkinkan pembangunan produksi berhasil selesai bahkan jika
